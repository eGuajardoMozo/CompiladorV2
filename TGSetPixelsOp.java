 ...
 * displayed.
 * <p>
 * Invoking Turtle methods which paint pixels on the graphics canvas does
 * not result in immediate changes to TG's in-memory BufferedImage, only
 * that they will be performed soon.
 * <p>
 * @author Guy Haas
 */
