...
public class TGFileIO
{
    ...
    * a root of a file system).  Return true if the path is absolute. If
    * the path is a relative path false is returned.
    */
   ...
   /**
    * Return a String array of file names, each the name of a .bmp, .gif,
    * .jpg, or .png picture file that is available for loading.
    */
